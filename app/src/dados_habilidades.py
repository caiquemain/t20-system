...
HABILIDADES_GERAIS = {
    ...
    "Devagar_Sempre_Anao": {
        ...
        "tipo": "Raça",
        "descricao": "Seu deslocamento é 6m. Não é reduzido por armadura ou excesso de carga.",
        "fonte": "T20 JdA",
    ...
    "Tradicao_Heredrimm_Anao": {
        ...
        "tipo": "Raça",
        "descricao": "Machados, martelos, marretas e picaretas são armas simples. Você recebe +2 em ataques com essas armas.",
        "fonte": "T20 JdA",
    ...
    "Amiga_Plantas_Dahllan": {
        ...
        "tipo": "Raça",
        "descricao": "Pode lançar Controlar Plantas (Sab). Custo -1 PM se aprender novamente.",
        "fonte": "T20 JdA",
        "efeitos": {
    ...
    "Armadura_Allihanna_Dahllan": {
        ...
        "tipo": "Raça",
        "descricao": "Ação de movimento e 1 PM para receber +2 na Defesa até o fim da cena.",
        "fonte": "T20 JdA",
        "efeitos": {}
    },
    "Empatia_Selvagem_Dahllan": {
        ...
        "tipo": "Raça",
        "descricao": "Pode se comunicar com animais. Usa Adestramento para mudar atitude e persuasão com animais.",
        "fonte": "T20 JdA",
    ...
    "Graca_Glorienn_Elfo": {
        ...
        "tipo": "Raça",
        "descricao": "Seu deslocamento é 12m.",
        "fonte": "T20 JdA",
    ...
    "Engenhoso_Goblin": {
        "nome": "Engenhoso",
        "tipo": "Raça",
        "descricao": "Não sofre penalidades em testes de perícia por não usar ferramentas. Se usar, recebe +2 no teste de perícia.",
        "fonte": "T20 JdA",
    ...
    "Peste_Esguia_Goblin": {
        "nome": "Peste Esguia",
        "tipo": "Raça",
        "descricao": "Seu tamanho é Pequeno, mas seu deslocamento se mantém 9m.",
        "fonte": "T20 JdA",
        "efeitos": {}
    },
    "Rato_Ruas_Goblin": {
    ...
    "Cria_Tormenta_Lefou": {
        ...
        "tipo": "Raça",
        "descricao": "Você é monstro e recebe +5 em testes de resistência contra efeitos causados por lefeu e pela Tormenta.",
        "fonte": "T20 JdA",
    ...
    "Deformidade_Lefou": {
        "nome": "Deformidade",
        "tipo": "Raça",
        "descricao": "Você recebe +2 em duas perícias a sua escolha. Você pode trocar um desses bônus por um poder da Tormenta.",
        "fonte": "T20 JdA",
        "efeitos": {
            "pericia_bonus_escolha": 1,
            "pericia_bonus_ou_poder_tormenta_escolha": 1
        }
    },
    ...
    "Couro_Rigido_Minotauro": {
        "nome": "Couro Rígido",
        "tipo": "Raça",
        "descricao": "Sua Defesa aumenta em +1.",
        "fonte": "T20 JdA",
    ...
    "Faro_Minotauro": {
        "nome": "Faro",
        "tipo": "Raça",
        "descricao": "Contra inimigos em alcance curto que não possa ver, você não fica desprevenido e camuflagem total lhe causa apenas 20% de chance de falha.",
        "fonte": "T20 JdA",
    ...
    "Medo_Altura_Minotauro": {
        "nome": "Medo de Altura",
        "tipo": "Raça",
        "descricao": "Se adjacente a queda de 3m ou mais, você fica abalado.",
        "fonte": "T20 JdA",
        "efeitos": {}
    },
    ...
    "Desejos_Qareen": {
        "nome": "Desejos",
        "tipo": "Raça",
        "descricao": "Se lançar magia que alguém tenha pedido, o custo da magia diminui em –1 PM (uma ação livre pedir).",
        "fonte": "T20 JdA",
        "efeitos": {}
    },
    "Resistencia_Elemental_Qareen": {
        ...
        "tipo": "Raça",
        "descricao": "Redução 10 a um tipo de dano (frio, eletricidade, fogo, ácido, luz ou trevas) à escolha.",
        "fonte": "T20 JdA",
    ...
    "Tatuagem_Mist_Qareen": {
        ...
        "tipo": "Raça",
        "descricao": "Pode lançar magia de 1º círculo à sua escolha (Car). Custo -1 PM se aprender novamente.",
        "fonte": "T20 JdA",
        "efeitos": {
    ...
    "Chassi_Golem": {
        "nome": "Chassi",
        "tipo": "Raça",
        "descricao": "Seu deslocamento é 6m, sem redução por armadura ou carga. Recebe +2 na Defesa, mas possui penalidade de armadura –2. Leva um dia para vestir/remover armadura.",
        "fonte": "T20 JdA",
    ...
    "Criatura_Artificial_Golem": {
        ...
        "tipo": "Raça",
        "descricao": "É construto. Visão no escuro. Imunidade a cansaço, metabólicos e veneno. Não precisa respirar/alimentar/dormir. Não se beneficia de cura mundana ou itens alimentação. Cura não funciona, mas Ofício(artesão) pode.",
        "fonte": "T20 JdA",
    ...
    "Fonte_Elemental_Golem": {
        ...
        "tipo": "Raça",
        "descricao": "Imune a um dano elemental à escolha (frio, eletricidade, fogo ou ácido). Dano mágico desse tipo cura metade dos PV.",
        "fonte": "T20 JdA",
    ...
    "Proposito_Criacao_Golem": {
        ...
        "tipo": "Raça",
        "descricao": "Não tem direito a escolher uma origem, mas recebe um poder geral à sua escolha.",
        "fonte": "T20 JdA",
    ...
    "Arremessador_Hynne": {
        "nome": "Arremessador",
        "tipo": "Raça",
        "descricao": "Ataques à distância com funda ou arremesso: dano aumenta em um passo.",
        "fonte": "T20 JdA",
    ...
    "Pequeno_Rechonchudo_Hynne": {
        ...
        "tipo": "Raça",
        "descricao": "Tamanho Pequeno, deslocamento 6m. Recebe +2 em Enganação e pode usar Destreza como atributo-chave de Atletismo.",
        "fonte": "T20 JdA",
    ...
    "Sorte_Salvadora_Hynne": {
        ...
        "tipo": "Raça",
        "descricao": "Ao fazer teste de resistência, gaste 1 PM para rolar o teste novamente.",
        "fonte": "T20 JdA",
        "efeitos": {}
    },
    ...
    "Hibrido_Kliren": {
        "nome": "Híbrido",
        "tipo": "Raça",
        "descricao": "Você se torna treinado em uma perícia à sua escolha.",
        "fonte": "T20 JdA",
    ...
    "Engenhosidade_Kliren": {
        "nome": "Engenhosidade",
        "tipo": "Raça",
        "descricao": "Gaste 2 PM para somar sua Inteligência em um teste de perícia (exceto ataque). Custo -1 PM se aprender novamente.",
        "fonte": "T20 JdA",
        "efeitos": {}
    },
    "Ossos_Frageis_Kliren": {
        "nome": "Ossos Frágeis",
        "tipo": "Raça",
        "descricao": "Você sofre 1 ponto de dano adicional por dado de dano de impacto.",
        "fonte": "T20 JdA",
    ...
    "Vanguardista_Kliren": {
        "nome": "Vanguardista",
        "tipo": "Raça",
        "descricao": "Você recebe proficiência em armas de fogo e +2 em Ofício (um qualquer, à sua escolha).",
        "fonte": "T20 JdA",
    ...
    "Natureza_Venenosa_Medusa": {
        ...
        "tipo": "Raça",
        "descricao": "Resistência a veneno +5. Ação de movimento e 1 PM para envenenar arma (perda de 1d12 PV).",
        "fonte": "T20 JdA",
        "efeitos": {"resistencia_veneno": 5}
    },
    "Olhar_Atordoante_Medusa": {
        "nome": "Olhar Atordoante",
        "tipo": "Raça",
        "descricao": "Ação de movimento e 1 PM para forçar Fortitude (CD Car) em alcance curto. Falha: atordoado por 1 rodada (1x/cena).",
        "fonte": "T20 JdA",
        "efeitos": {}
    },
    ...
    "Memoria_Postuma_Osteon": {
        ...
        "tipo": "Raça",
        "descricao": "Torna-se treinado em uma perícia ou recebe um poder geral à sua escolha. Ou ganha uma habilidade de outra raça humanoide.",
        "fonte": "T20 JdA",
    ...
    "Natureza_Esqueletica_Osteon": {
        ...
        "tipo": "Raça",
        "descricao": "É morto-vivo. Visão no escuro. Imunidade a cansaço, metabólicos, trevas e veneno. Não precisa respirar/alimentar/dormir. Magia de cura de luz causa dano; dano de trevas recupera PV.",
        "fonte": "T20 JdA",
    ...
    "Preco_Nao_Vida_Osteon": {
        ...
        "tipo": "Raça",
        "descricao": "Precisa passar 8h sob a luz de estrelas ou no subterrâneo para recuperar PV e PM por descanso (caso contrário, sofre fome).",
        "fonte": "T20 JdA",
        "efeitos": {}
    },
    ...
    "Cancao_Mares_Sereia": {
        ...
        "tipo": "Raça",
        "descricao": "Lança duas magias (Amedrontar, Comando, Despedaçar, Enfeitiçar, Hipnotismo ou Sono) (Car). Custo -1 PM se aprender novamente.",
        "fonte": "T20 JdA",
    ...
    "Mestre_Tridente_Sereia": {
        ...
        "tipo": "Raça",
        "descricao": "Tridente é arma simples. Recebe +2 em rolagens de dano com azagaias, lanças e tridentes.",
        "fonte": "T20 JdA",
    ...
    "Transf_Anfibia_Sereia": {
        ...
        "tipo": "Raça",
        "descricao": "Pode respirar debaixo d’água. Deslocamento de natação 12m. Fora d'água: pernas, deslocamento 9m. Penalidade de descanso se ficar 1 dia sem água.",
        "fonte": "T20 JdA",
    ...
    "Asas_Borboleta_Silfide": {
        ...
        "tipo": "Raça",
        "descricao": "Tamanho Minúsculo. Pode pairar a 1,5m do chão com deslocamento 9m (ignora difícil, imune a queda). Gasta 1 PM/rodada para voar 12m.",
        "fonte": "T20 JdA",
        "efeitos": {"deslocamento": 9, "deslocamento_voo_base": 1.5}
    },
    "Esp_Natureza_Silfide": {
        "nome": "Espírito da Natureza",
        "tipo": "Raça",
        "descricao": "É espírito. Visão na penumbra e pode falar com animais livremente.",
        "fonte": "T20 JdA",
        "efeitos": {"tipo_criatura": "Espírito", "visao_penumbra": True}
    },
    "Magia_Fadas_Silfide": {
        "nome": "Magia das Fadas",
        "tipo": "Raça",
        "descricao": "Lança duas magias (Criar Ilusão, Enfeitiçar, Luz (arcana) e Sono) (Car). Custo -1 PM se aprender novamente.",
        "fonte": "T20 JdA",
    ...
    "Heranca_Divina_Suraggel": {
        "nome": "Herança Divina",
        "tipo": "Raça",
        "descricao": "É espírito e recebe visão no escuro.",
        "fonte": "T20 JdA",
    ...
    "Luz_Sagrada_Aggelus": {
        ...
        "tipo": "Raça",
        "descricao": "+2 em Diplomacia e Intuição. Pode lançar Luz (divina) (Car). Custo -1 PM se aprender novamente.",
        "fonte": "T20 JdA",
        "efeitos": {
    ...
    "Sombras_Prof_Sulfure": {
        ...
        "tipo": "Raça",
        "descricao": "+2 em Enganação e Furtividade. Pode lançar Escuridão (divina) (Int). Custo -1 PM se aprender novamente.",
        "fonte": "T20 JdA",
        "efeitos": {
    ...
    },  # <--- ERRO CORRIGIDO AQUI (Adicionada a chave de fechamento)

    # --- TROG ---
    "Mau_Cheiro_Trog": {
        "nome": "Mau Cheiro",
        "tipo": "Raça",
        "descricao": "Ação padrão e 2 PM para expelir gás fétido (Fortitude CD Con ou enjoado 1d6 rodadas). Imunidade por 1 dia ao passar.",
        "fonte": "T20 JdA",
        "efeitos": {}
    },
    "Mordida_Trog": {
        "nome": "Mordida",
        "tipo": "Raça",
        "descricao": "Arma natural de mordida (dano 1d6, crítico x2, perfuração). 1 PM extra ataque corpo a corpo extra com a mordida (1x/rodada).",
        "fonte": "T20 JdA",
        "efeitos": {}
    },
    "Reptiliano_Trog": {
        "nome": "Reptiliano",
        "tipo": "Raça",
        "descricao": "É monstro. Visão no escuro, +1 na Defesa e +5 em Furtividade (sem armadura ou roupas pesadas).",
        "fonte": "T20 JdA",
