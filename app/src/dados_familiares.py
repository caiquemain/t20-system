...
FAMILIARES_ARCANOS = {
    ...
    "Coruja": {"habilidade_ativavel": {"custo": 1, "acao": "Livre", "alcance": "Pessoal",
               "duracao": "Cena", "modificadores": [{"atributo": "alcance_magia_toque", "valor": 1}]},
               "descricao": "Pague 1 PM para mudar alcance de toque para curto."},
    "Corvo": {"habilidade_ativavel": {"custo": 1, "acao": "Livre", "alcance": "Pessoal",
              "duracao": "Cena", "modificadores": [{"atributo": "vantagem_misticismo_vontade", "valor": 1}]},
    ...
    "Rato": {"pericia_atributo_opcao": {"Fortitude": "attr_chave"},
             "nota": "Atributo-chave em Fortitude no lugar de Constituição",
